...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\K.Ternovsky\PycharmProjects\Int_In_Str\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\K.Ternovsky\PycharmProjects\Int_In_Str\venv\Scripts\deactivate.nu'
